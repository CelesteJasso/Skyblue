...
import ztb from './ztbustamante.jpg'
import ztm from './ztmonterrey.jpg'
import zts from './ztsantacata.jpg'
                ...
                <Grid.Col span={5}>
                    <div>
                        ...
                        <Carousel width={230} >
                            <div>
                                <img src={ztb} />
                                    // <p className="legend">Bustamante</p>
                            </div>
                            <div>
                                <img src={ztm} />
                            ...
                            <div>
                                <img src={zts} />
                                <p className="legend">Santa Catarina</p>
                            </div>
                        </Carousel>
                    </div>
                </Grid.Col>
