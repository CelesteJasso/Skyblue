...
function App() {
  ...
  return (
    <div>
      ...
      <br />
      <div>
        <h1> Apartado de mejora de experiencia para el usuario </h1>
      </div>
      <Grid>
        <Grid.Col span={1}>
          <br />
        ...
        <Grid.Col span={5}>
          <div>
            ...
            <iframe src="https://www.google.com/maps/embed?pb=!1m16!1m12!1m3!1d460347.9776983164!2d-100.84060681830245!3d25.655757411671814!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!2m1!1szonas%20industriales!5e0!3m2!1ses-419!2smx!4v1670457425029!5m2!1ses-419!2smx" width="800" height="800"></iframe>
          </div>
        </Grid.Col>
        <Grid.Col span={5}>
          <div>
          ...
          <Table captionSide="top" horizontalSpacing="xl" striped highlightOnHover>
            ...
            <ScrollArea style={{ height: 550 }} scrollbarSize={15}>
              <thead>
                <tr>
      ...
      <div>
        <h1> Apartado de Analisis de Datos para All Property </h1>
      </div>
      <div>
        <h1>
          Precios que se manejan por numeros de Recamaras.
        </h1>
        <Image
          width={500}
          height={100}
