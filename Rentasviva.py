...
@app.get("/getJSON/")
async def getJSON():
    csvFilePath = r'Rentasvivanuncios.csv'
    jsonFilePath = r'Ventasvivanuncios.json'
...
def get_url(num_pagina):
    url = 'https://www.vivanuncios.com.mx/s-renta-inmuebles/'
    url += 'nuevo-leon/v1c1098l1018p'
    url += str(num_pagina)
    return url
